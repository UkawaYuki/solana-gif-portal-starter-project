...
// createKeyPair.jsで作成したGIFデータを保持するアカウントのキーペアを取得します。
...
// const TEST_GIFS = [
//   // 'https://media.giphy.com/media/3o7aCXISLlFbbREbAI/giphy.gif',
//   // 'https://media.giphy.com/media/l3vRkxB7z9JfJILJe/giphy.gif',
//   'https://media.giphy.com/media/frGRXgb9an9lmLpwFy/giphy.gif',
//   'https://media.giphy.com/media/afumdczHhRVug/giphy.gif',
//   'https://media.giphy.com/media/xUPGcB5L0TIfLrDH8c/giphy.gif'
// ]
  ...
  return (
    <div className="App">
      <div className="container">
        ...
        <main className="main">
          {walletAddress ? (<p className='sub-text'>Connected to : {walletAddress}</p>) : null}
